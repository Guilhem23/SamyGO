...
void *_ZN16SCShadowGraphics9ChangeResElll(_THIS,int w,int h,void *d,void *e,void *f,void *g,void *i){
	printf("%s: a %p w %d h %d -> %p d %p e %p f %p g %p i %p\n",__FUNCTION__,this,w,h,h,d,e,f,g,i);
	if (w > 960) {
		w=960;
		h=540;
		exit(2);
...
void _Z14s_UpdateScreeniiiii(_THIS, void *b, void *c){
...
int _Z11spiFillRectPvPKjmiiiii(SDL_Surface *dst, SDL_Rect *dstrect, Uint32 color, void *a, void *b, void *c){
