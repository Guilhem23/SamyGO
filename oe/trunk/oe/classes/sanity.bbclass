...
def check_sanity(e):
	...
	if not check_app_exists('help2man', e.data):
		raise_sanity_error('Please install the help2man binary')
	...
	if not check_app_exists('makeinfo', e.data):
		raise_sanity_error('Please install the texinfo package')

	if not check_app_exists('unzip', e.data):
		raise_sanity_error('Please install the unzip package')

	if not check_app_exists('intltoolize', e.data):
		raise_sanity_error('Please install the intltool package')
