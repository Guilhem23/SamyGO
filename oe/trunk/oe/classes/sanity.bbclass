...
def check_sanity(e):
	...
	#SamyGO: added: wget, intltoolize, desktop-file-install
	required_utilities = "patch help2man diffstat texi2html makeinfo cvs svn bzip2 tar gzip gawk md5sum chrpath wget intltoolize desktop-file-install"
