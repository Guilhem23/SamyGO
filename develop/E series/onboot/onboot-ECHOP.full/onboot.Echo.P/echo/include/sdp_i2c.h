...
#else // Port for Genoa-S 

#define IICCON(port)		REGL(((port)*0x20) + 0x0)
#define IICSTAT(port)		REGL(((port)*0x20) + 0x4)
#define IICADD(port)		REGL(((port)*0x20) + 0x8)
#define IICDS(port)			REGL(((port)*0x20) + 0xc)
#define IICCONE(port)			REGL(((port)*0x20) + 0x10)
#define IICSTATP			REGL(0xf4)
#define IICEN				REGL(0xf8)
