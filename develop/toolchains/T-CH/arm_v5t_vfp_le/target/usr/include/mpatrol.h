...
#define ARCH_SH      12 /* SuperHitachi */
...
#elif defined(arm) || defined(_arm) || defined(__arm) || \
      defined(__arm__)
...
#elif defined (sh) || defined (_sh) || defined (__sh) || \
      defined(__sh__)
#define ARCH ARCH_SH
#else /* ARCH */
...
#if !defined(MP_INLINE) && ((ARCH == ARCH_POWERPC) || (ARCH == ARCH_ARM) || \
  (ARCH == ARCH_MIPS) || (ARCH == ARCH_SH))
#define MP_INLINE
#endif
