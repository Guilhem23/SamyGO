...
#define PHP_IFX_LIBS		""
#define PHP_INSTALL_IT		"$(mkinstalldirs) '$(INSTALL_ROOT)/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/lib/apache/' &&                 $(mkinstalldirs) '$(INSTALL_ROOT)/opt/montavista/foundation/devkit/arm/v5t_le/target/etc/apache' &&                  /opt/montavista/foundation/devkit/arm/v5t_le/bin/apxs -S LIBEXECDIR='$(INSTALL_ROOT)/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/lib/apache/'                        -S SYSCONFDIR='$(INSTALL_ROOT)/opt/montavista/foundation/devkit/arm/v5t_le/target/etc/apache'                        -i -a -n php4 libphp4.la"
...
#define PHP_EXTENSION_DIR       "/usr/lib/extensions/no-debug-non-zts-20020429"
