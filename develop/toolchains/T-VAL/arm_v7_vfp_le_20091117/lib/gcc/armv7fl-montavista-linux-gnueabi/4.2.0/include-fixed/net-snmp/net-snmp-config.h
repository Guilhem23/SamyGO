/*  DO NOT EDIT THIS FILE.
	...
	"/opt/mvl.5024.mobil.arm.v7.vfp.le.omap3530/mobilinux/devkit/arm/v7_vfp_le/target/usr/include/net-snmp/net-snmp-config.h"
...
#define NETSNMP_DEFAULT_MIBS ":HOST-RESOURCES-MIB:HOST-RESOURCES-TYPES:IPFWCHAINS-MIB:TCP-MIB:UDP-MIB:MTA-MIB:NETWORK-SERVICES-MIB:UCD-DISKIO-MIB:IP-MIB:IF-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:IPV6-ICMP-MIB:IPV6-MIB:IPV6-TCP-MIB:IPV6-UDP-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB"
...
#define NETSNMP_CONFIGURE_OPTIONS "'--host=armv7fl-montavista-linux-gnueabi' '--build=i686-pc-linux-gnu' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--sysconfdir=/etc' '--datadir=/usr/share' '--includedir=/usr/include' '--libdir=/usr/lib' '--libexecdir=/usr/libexec' '--localstatedir=/var' '--sharedstatedir=/usr/share' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--includedir=/usr/include/net-snmp' '--with-persistent-directory=/var/net-snmp' '--enable-ipv6' '--enable-shared' '--with-libwrap' '--with-logfile=' '--with-openssl' '--without-dmalloc' '--without-efense' '--with-sys-contact=root@localhost' '--with-sys-location=unknown' '--with-mib-modules=host ipfwchains/ipfwchains smux agentx tcp-mib udp-mib ip-mib/ipv4InterfaceTable ip-mib/ipv6InterfaceTable disman/event-mib mibII/mta_sendmail ucd-snmp/diskio disman/schedule' '--without-rpm' '--with-endianness=little' '--with-perl-modules' '--disable-debugging' '--with-defaults' '--with-cflags=-O2 -Dlinux -I. -D_REENTRANT -D_GNU_SOURCE -DTHREADS_HAVE_PIDS -fno-strict-aliasing -I/opt/montavista/foundation/devkit/arm/v7_vfp_le/target/usr/lib/perl/5.8.4/CORE -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -DARP_SCAN_FOUR_ARGUMENTS=1' '--with-ldflags=-Wl,-E  -L/opt/montavista/foundation/devkit/arm/v7_vfp_le/target/usr/lib -L/opt/montavista/foundation/devkit/arm/v7_vfp_le/target//usr/lib/perl/5.8.4/CORE -lperl -ldl -lm -lc -lcrypt /opt/montavista/foundation/devkit/arm/v7_vfp_le/target//usr/lib/perl/5.8.4/auto/DynaLoader/DynaLoader.a' 'CC=arm_v7_vfp_le-gcc ' 'CFLAGS=-O2' 'CPP=arm_v7_vfp_le-cpp ' 'CXXFLAGS=-O2' 'CXX=arm_v7_vfp_le-g++ ' 'FFLAGS=-O2' 'LDFLAGS=' 'build_alias=i686-pc-linux-gnu' 'host_alias=armv7fl-montavista-linux-gnueabi'"
