/*  DO NOT EDIT THIS FILE.
	...
	"/opt/mvl.500.pro.mips24ke.nfp.be.TridentSX/pro/devkit/mips/mips24ke_nfp_be/target/usr/include/net-snmp/net-snmp-config.h"
...
#define NETSNMP_CONFIGURE_OPTIONS "'--host=mips-montavista-linux' '--build=i686-pc-linux-gnu' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--sysconfdir=/etc' '--datadir=/usr/share' '--includedir=/usr/include' '--libdir=/usr/lib' '--libexecdir=/usr/libexec' '--localstatedir=/var' '--sharedstatedir=/usr/share' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--includedir=/usr/include/net-snmp' '--with-persistent-directory=/var/net-snmp' '--enable-ipv6' '--enable-shared' '--with-libwrap' '--with-logfile=' '--with-openssl' '--without-dmalloc' '--without-efense' '--with-sys-contact=root@localhost' '--with-sys-location=unknown' '--with-mib-modules=host ipfwchains/ipfwchains smux agentx tcp-mib udp-mib ip-mib/ipv4InterfaceTable ip-mib/ipv6InterfaceTable disman/event-mib mibII/mta_sendmail ucd-snmp/diskio disman/schedule' '--without-rpm' '--with-endianness=big' '--with-perl-modules' '--with-defaults' '--with-cflags=-O2 -Dlinux -I. -D_REENTRANT -D_GNU_SOURCE -DTHREADS_HAVE_PIDS -fno-strict-aliasing -I/opt/montavista/foundation/devkit/mips/mips24ke_nfp_be/target/usr/lib/perl/5.8.4/CORE -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -DARP_SCAN_FOUR_ARGUMENTS=1' '--with-ldflags=-Wl,-E  -L/opt/montavista/foundation/devkit/mips/mips24ke_nfp_be/target/usr/lib -L/opt/montavista/foundation/devkit/mips/mips24ke_nfp_be/target//usr/lib/perl/5.8.4/CORE -lperl -ldl -lm -lc -lcrypt /opt/montavista/foundation/devkit/mips/mips24ke_nfp_be/target//usr/lib/perl/5.8.4/auto/DynaLoader/DynaLoader.a' 'CC=mips24ke_nfp_be-gcc ' 'CFLAGS=-O2' 'CPP=mips24ke_nfp_be-cpp ' 'CXXFLAGS=-O2' 'CXX=mips24ke_nfp_be-g++ ' 'FFLAGS=-O2' 'LDFLAGS=' 'build_alias=i686-pc-linux-gnu' 'host_alias=mips-montavista-linux'"
