/*
 * linux/include/asm-arm/arch-s5h2150/timer.h
 *
...
#ifndef _S5H2150_TIMER_H_
#define _S5H2150_TIMER_H_

/* timer */
#define V_TIMER(t, offset)	*(volatile unsigned *)(V_TIMER_BASE+(0x10*t)+(offset))
...
#define TMDATA_PRES(x)	((x > 0) ? ((x & 0xFF) << 16) : (1 << 16))
